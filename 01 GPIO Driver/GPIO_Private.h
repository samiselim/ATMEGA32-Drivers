...
#define DDRB _MMIO_BYTE(0x18 + __SFR_OFFSET)
#define PORTB _MMIO_BYTE(0x17 + __SFR_OFFSET)
#define PINB _MMIO_BYTE(0x16 + __SFR_OFFSET)

/* ADDRESSES FOR SFR OF PORTC */
#define DDRC _MMIO_BYTE(0x15 + __SFR_OFFSET)
#define PORTC _MMIO_BYTE(0x14 + __SFR_OFFSET)
#define PINC _MMIO_BYTE(0x13 + __SFR_OFFSET)

/* ADDRESSES FOR SFR OF PORTD */
#define DDRD _MMIO_BYTE(0x12 + __SFR_OFFSET)
#define PORTD _MMIO_BYTE(0x11 + __SFR_OFFSET)
